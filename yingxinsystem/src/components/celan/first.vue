		...
		<div class="second"> 
			<el-table
				...
				<el-table-column label="操作">
				        <router-link to='/chakan'><span style='margin-left: 10px; color: #93CEFA'>查看</span></router-link>
				    </el-table-column>
			  </el-table>
			  <div align="center" style="margin: 20px;">
				  <router-link to='/admin'><span style='margin-left: 10px; color: #aa00ff'>更多>></span></router-link>
			  </div>
